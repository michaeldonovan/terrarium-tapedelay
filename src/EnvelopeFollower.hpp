...
public:
    ...
    Dynamics(float attackMS, float releaseMS, float holdMS, float ratio, float knee, float SampleRate){
        init(attackMS, releaseMS, holdMS, ratio, knee, SampleRate);
    }
    
    
    void init(float attackMS, float releaseMS, float holdMS, float ratio, float knee, float SampleRate){
